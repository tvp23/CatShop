...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav d-flex" style="width: 100%;">
            <li class="nav-item <?php if ($currentPage == 'index') echo htmlentities("active") ?>">
                <a class="nav-link" href="index.php">Home</a>
            </li>
            <li class="nav-item <?php if ($currentPage == 'products') echo htmlentities("active") ?>">
                <a class="nav-link" href="products.php">Products</a>
            </li>
            <?php if ($_SESSION != null) {
                if ($_SESSION['role'] != 'user') {
            ?>
                    <li class="nav-item <?php if ($currentPage == 'files') echo htmlentities("active") ?>">
                        <a class="nav-link" href="files.php">Files</a>
                    </li>
                    <?php if ($_SESSION['role'] != 'admin') { ?>
                        <li class="nav-item <?php if ($currentPage == 'alerts') echo htmlentities("active") ?>">
        ...
        <ul class="navbar-nav mr-auto my-2 my-lg-0 navbar-nav-scroll" style="max-height: 100px; margin:0em;">
            <?php if ($_SESSION != null) { ?>
                <li class="nav-item dropdown <?php if ($currentPage == 'settings') echo htmlentities("active") ?> <?php if ($currentPage == 'users') echo htmlentities("active") ?>">
